...
MATCH_FUNC(0x503410)
u8 miss2_0x11C::GetEntityTypeOfCommand_503410(u32 opcode)
{
    switch (opcode)
    {
        ...
        case SCRCMD_OBJ_DECSET_2D_INT:
        case SCRCMD_OBJ_DECSET_3D_INT:
        case SCRCMD_OBJ_DECSET_2D_STR:
        case SCRCMD_OBJ_DECSET_3D_STR:
        case SCRCMD_CREATE_OBJ_2D:
        case SCRCMD_CREATE_OBJ_3D:
        case SCRCMD_CREATE_OBJ_3D_INT:
        case SCRCMD_CREATE_OBJ_2D_INT:
...
MATCH_FUNC(0x503620)
void miss2_0x11C::Next_503620(SCR_CMD_HEADER* pCmd)
{
...
MATCH_FUNC(0x503650)
void miss2_0x11C::JumpToCmd_503650(u16 cmdIdx)
{
    if (cmdIdx != 0xFFFF)
    {
        field_4_next_cmd = cmdIdx;
    }
    else
    {
        miss2_0x11C::EndCmd_503670();
...
{
    Player* pPlayer = gGame_0x40_67E008->GetFirstPlayerWithoutPed_4B9750();
...
MATCH_FUNC(0x503fb0)
void miss2_0x11C::SCRCMD_CHAR_DECSET_2D_3D_503FB0(SCR_CHAR_DATA_DEC* pCmd, SCR_POINTER* pPointer)
{
    Ped* pPed;
...
MATCH_FUNC(0x504110)
Ped* miss2_0x11C::SetCharObjective_504110(SCR_CHAR_OBJECTIVE* pCmd, SCR_POINTER* pPointer)
{
...
MATCH_FUNC(0x5041c0)
void miss2_0x11C::SCRCMD_CRANE_5041C0(SCR_CRANE_TARGET_DEC* pTargetCmd, SCR_CRANE_BASIC_DEC* pBasicCmd)
{
    pBasicCmd->field_8_crane =
        gCranePool_D9C_679FD4->NewCrane_480EC0(pTargetCmd->field_10_pos.field_0_x, pTargetCmd->field_10_pos.field_4_y);

    if (pTargetCmd->field_2_type == SCRCMD_CRANE_TARGET_DEC)
    {
        if (pTargetCmd->field_1A_home_cranetype == 0)
        {
            ...
            pTargetCmd->field_8_crane->CraneTargetPickupCheck_480900(pTargetCmd->field_1C_target_pos.field_0_x,
                                                                     pTargetCmd->field_1C_target_pos.field_4_y,
                                                                     rotation);
        }
...
void miss2_0x11C::SCRCMD_CONVEYOR_DECSET1_2_5043A0(SCR_CONVEYOR* pCmd, SCR_POINTER* pPointer)
{
    ...
    pPointer->field_8_obj = gObject_5C_6F8F84->NewTouchPoint_529950(139,
...
void miss2_0x11C::SCRCMD_GENERATOR_DECSET_504420(SCR_GENERATOR* pCmd, SCR_POINTER* pPointer)
{
    ...
    {
        pPointer->field_8_generator->field_1C_ammo = pCmd->field_20_ammo;
    }
}
...
void miss2_0x11C::SCRCMD_DESTRUCTOR_DECSET_504530(SCR_DESTRUCTOR* pCmd, SCR_POINTER* pPointer)
{
    ...
    pPointer->field_8_obj = gObject_5C_6F8F84->NewTouchPoint_529950(141,
                                                                    pCmd->field_C_rect.field_0_pos.field_0_x,
                                                                    pCmd->field_C_rect.field_0_pos.field_4_y,
                                                                    pCmd->field_C_rect.field_0_pos.field_8_z,
                                                                    dword_6F804C,
...
MATCH_FUNC(0x5045a0)
void miss2_0x11C::SCRCMD_CRUSHER_BASIC_5045A0(SCR_CRUSHER_BASIC* pCmd, SCR_POINTER* pPointer)
{
    pPointer->field_8_crusher = gCrusherPool_94_67A830->CreateCrusher_488820(pCmd->field_C_pos.field_0_x, pCmd->field_C_pos.field_4_y);
}
...
MATCH_FUNC(0x504660)
void miss2_0x11C::SCRCMD_THREAD_DECLARE3_504660(SCR_THREAD* pThread)
{
    SCR_THREAD* pCmd = pThread;
...
MATCH_FUNC(0x504950)
void miss2_0x11C::SCRCMD_SET_DOOR_INFO_504950(SCR_FOUR_PARAMS* pCmd)
{
    gDoor_4D4_67BD2C->RegisterDoorInfo_49D2D0(pCmd->field_8_unsigned_1, pCmd->field_A_unsigned_2, pCmd->field_C_unsigned_3);
}

MATCH_FUNC(0x504970)
void miss2_0x11C::SCRCMD_DOOR_DECLARE_D1_S1_504970(SCR_DOOR_DATA_DEC* pCmd)
{
    if (pCmd->field_2_type == SCRCMD_DOOR_DECLARE_S1)
    {
        ...
        else
        {
            pCmd->field_8 = gDoor_4D4_67BD2C->RegisterSingleDoor_49D170(pCmd->field_10_gr_id,
                                                                        ...
                                                                        pCmd->field_C_block.field_2_z,
                                                                        pCmd->field_F_face,
                                                                        pCmd->field_14_check.field_0_pos.field_0_x,
                                                                        pCmd->field_14_check.field_0_pos.field_4_y,
                                                                        pCmd->field_14_check.field_0_pos.field_8_z,
                                                                        pCmd->field_14_check.field_C_size.field_0_x,
                                                                        pCmd->field_14_check.field_C_size.field_4_y,
                                                                        pCmd->field_28_flip,
                                                                        pCmd->field_29_reversed);
        }
    }
...
MATCH_FUNC(0x504b80)
void miss2_0x11C::SCRCMD_DOOR_DECLARE_D2_S2_504B80(SCR_DOOR_DATA_DEC* pCmd)
{
...
MATCH_FUNC(0x504dd0)
void miss2_0x11C::SCRCMD_DECLARE_MISSION_504DD0(SCR_TWO_PARAMS* pCmd)
{
...
MATCH_FUNC(0x5051d0)
void miss2_0x11C::SCRCMD_RADIOSTATION_DEC_5051D0(SCR_RADIOSTATION_DEC* pCmd)
{
    gRoot_sound_66B038.DeclareRadioStation_40F030(pCmd->field_10_station_type, pCmd->field_8_pos.field_0_x, pCmd->field_8_pos.field_4_y);
}
...
MATCH_FUNC(0x505340)
void miss2_0x11C::SCRCMD_SOUND_DECSET_505340(SCR_SOUND_DECSET* pCmd, SCR_POINTER* pPointer)
{
...
MATCH_FUNC(0x505f50)
void miss2_0x11C::SCRCMD_DISPLAY_MESSAGES_505F50(SCR_TWO_PARAMS* pCmd)
{
    if (gDo_text_id_test_67D6D0)
    {
        ...
        if (!gText_0x14_704DFC->Find_5B5F90(gTmpBuffer_67C598))
        {
            FatalError_4A38C0(Gta2Error::MissionScriptIsReferringToTextIdThatDoesNotExist,
                              ...
                              2460,
                              pCmd->field_8_unsigned_1); // Mission script is referring to a 'text id' that doesn't exist. ID
        }
    }
}
...
MATCH_FUNC(0x506140)
void miss2_0x11C::SCRCMD_START_BASIC_KF_506140(u16* pKfValue)
{
...
void miss2_0x11C::SCRCMD_STOP_THREAD_506A60()
{
    ...
    s32 opcode_idx = pThread->field_2_type;
    if (opcode_idx != SCRCMD_THREAD_ID)
    {
...
MATCH_FUNC(0x507f80)
void miss2_0x11C::SCRCMD_CREATE_CAR_507F80()
{
...
MATCH_FUNC(0x508550)
void miss2_0x11C::SCRCMD_POINT_ARROW_3D_508550() //  SCRCMD_POINT_ARROW_3D and SCRCMD_LEVEL_END_ARROW2
{
...
MATCH_FUNC(0x5086f0)
void miss2_0x11C::SCRCMD_POINT_ARROW_AT_5086F0()
{
    ...
    switch (miss2_0x11C::GetEntityTypeOfCommand_503410(pEntityPtr->field_2_type))
    {
        ...
        case 5: // conveyor
            pArrowPtr->field_8_arrow->SetArrowAim_476840(((SCR_CONVEYOR*)pEntityPtr)->field_C_rect.field_0_pos.field_0_x,
                                                         ((SCR_CONVEYOR*)pEntityPtr)->field_C_rect.field_0_pos.field_4_y,
                                                         ((SCR_CONVEYOR*)pEntityPtr)->field_C_rect.field_0_pos.field_8_z);
            break;
...
MATCH_FUNC(0x5093c0)
void miss2_0x11C::SCRCMD_DISPLAY_MESSAGE_5093C0()
{
    SCR_TWO_PARAMS* pCmd = (SCR_TWO_PARAMS*)gBasePtr_6F8070;
...
MATCH_FUNC(0x5097d0)
void miss2_0x11C::SCRCMD_SET_CHAR_OBJ1_5097D0()
{
...
MATCH_FUNC(0x5098e0)
void miss2_0x11C::SCRCMD_GIVE_WEAPON_5098E0()
{
    SCR_TWO_PARAMS* pCmd = (SCR_TWO_PARAMS*)gBasePtr_6F8070;
    ...
    if (miss2_0x11C::GetEntityTypeOfCommand_503410(pPointer->field_2_type) == 1)
    {
        ...
        {
            pPointer->field_8_char->AddWeaponWithAmmo_45DD30(pCmd->field_A_signed_2, 100);
        }
        else
        {
            pPointer->field_8_char->AddWeaponWithAmmo_45DD30(pCmd4->field_A_signed_2, pCmd4->field_C_signed_3);
        }
    }
    else
    {
        // Always 50 ammo for cars
        gWeapon_8_707018->allocate_5E3D50(pCmd->field_A_signed_2, 50, pPointer->field_8_car);
    }
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
MATCH_FUNC(0x509d60)
void miss2_0x11C::SCRCMD_DELETE_ITEM_509D60()
{
    miss2_0x11C::DeallocOrDeleteItem_505B10(gBasePtr_6F8070->field_8_index); //  delete item
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
MATCH_FUNC(0x509ed0)
void miss2_0x11C::SCRCMD_EXPLODE_509ED0()
{
...
MATCH_FUNC(0x50a3e0)
void miss2_0x11C::SCRCMD_SET_CHAR_OBJ3_50A3E0()
{
    SCR_CHAR_OBJ3* pCmd;
    SCR_POINTER* pPointer;
    ...
    if (pPointer->field_8_char)
    {
        (pPointer->field_8_char)->field_1DC_objective_target_x = pCmd->field_C_pos.field_0_x.mValue; //  TODO: May be Fix16 in cool_nash
...
MATCH_FUNC(0x50a460)
void miss2_0x11C::SCRCMD_SET_CHAR_OBJ_FOLLOW_50A460()
{
    SCR_CHAR_OBJECTIVE* pCmd;
    SCR_POINTER* pPointer;
...
{
    SCR_CMD_HEADER* pNextCmd = ((SCR_CMD_HEADER*)gBasePtr_6F8070) + 1; //  TODO: remove this hack

    if ((s16)gBasePtr_6F8070->field_8_index == -1)
    {
        pNextCmd->field_0_cmd_this = ((SCR_CMD_HEADER*)gBasePtr_6F8070)[1].field_2_type;
    }
    else
    {
        pNextCmd->field_0_cmd_this = gBasePtr_6F8070->field_8_index - 1;
...
MATCH_FUNC(0x50a980)
void miss2_0x11C::SCRCMD_DELAY_50A980()
{
    ...
    {
        pNextCmd->field_0_cmd_this = param_1 - 1;
        if (!pNextCmd->field_0_cmd_this)
        {
            pNextCmd->field_0_cmd_this = -1;
            field_8 = false;
...
{
    miss2_0x11C::DisableThread_505790(gBasePtr_6F8070->field_8_index);
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
{
    miss2_0x11C::EnableThread_50A9E0(gBasePtr_6F8070->field_8_index);
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}

MATCH_FUNC(0x50ac20)
void miss2_0x11C::SCRCMD_SET_GANG_KILL_REACTION_50AC20()
{
...
MATCH_FUNC(0x50acf0)
void miss2_0x11C::SCRCMD_CHANGE_RESPECT_50ACF0()
{
    SCR_FOUR_PARAMS* pCmd = (SCR_FOUR_PARAMS*)gBasePtr_6F8070;
...
{
    SCR_TWO_PARAMS* pCmd = (SCR_TWO_PARAMS*)gBasePtr_6F8070;
    SCR_POINTER* pPointer = (SCR_POINTER*)gfrosty_pasteur_6F8060->GetBasePointer_512770(((SCR_CMD_HEADER*)gBasePtr_6F8070)[1].field_2_type);

    SCR_POINTER* pPointer_2 = (SCR_POINTER*)gfrosty_pasteur_6F8060->GetBasePointer_512770(pCmd->field_8_unsigned_1);
...
void miss2_0x11C::SCRCMD_DRIVER_OUT_CAR_50B5A0()
{
    ...
    if (pPointer->field_8_char)
    {
        ...
        pPointer->field_8_char->SetObjective(objectives_enum::leave_car_36, 9999);
        pPointer->field_8_char->field_150_target_objective_car = pPointer->field_8_char->field_16C_car;
    }
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
void miss2_0x11C::SCRCMD_SET_NO_COLLIDE_50B8B0()
{
    ...
    if (pCar)
    {
        ...
        else if (gBasePtr_6F8070->field_2_type == SCRCMD_CLEAR_NO_COLLIDE)
        {
...
void miss2_0x11C::SCRCMD_ALT_WANTED_LEVEL_50BA70()
{
    ...
    {
        if (!pPointer->field_8_char->WantedStartCountLessThan_46F100(kGlobal->field_C_wanted_level))
        {
            pPointer->field_8_char->set_wanted_star_count_46F070(kGlobal->field_C_wanted_level);
        }
    }
    else
    {
...
void miss2_0x11C::SCRCMD_IS_CHAR_IN_ZONE_50BF40()
{
    ...
    {
        pZone1 = gMap_0x370_6F6268->zone_by_pos_and_type_4DF4D0(pPointer->field_8_char->get_cam_x().ToInt(),
                                                                pPointer->field_8_char->get_cam_y().ToInt(),
                                                                16);
        pZone2 = gMap_0x370_6F6268->zone_by_pos_and_type_4DF4D0(pPointer->field_8_char->get_cam_x().ToInt(),
                                                                pPointer->field_8_char->get_cam_y().ToInt(),
                                                                1);
    }
...
void miss2_0x11C::SCRCMD_IS_GROUP_IN_CAR_50C470()
{
    ...
    if (pGroup != NULL)
    {
        allInCar = pGroup->IsAllMembersInSomeCar_4CAA20();
    }
    else
    {
        allInCar = (pGroupLeader->field_16C_car != NULL);
    }
    if (allInCar)
    {
        field_8 = true;
...
void miss2_0x11C::SCRCMD_EXPLODE_50C5A0()
{
    ...
    switch (miss2_0x11C::GetEntityTypeOfCommand_503410(pPointer->field_2_type))
    {
        ...
        case 4:
        {
            SCR_CRANE_TARGET_DEC* pCrane = (SCR_CRANE_TARGET_DEC*)pPointer;
...
void miss2_0x11C::SCRCMD_DOOR_50C8A0()
{
    ...
    switch (gBasePtr_6F8070->field_2_type)
    {
        ...
        {
            Door_38* door = pPointer->field_8_door;
...
MATCH_FUNC(0x50ca70)
void miss2_0x11C::SCRCMD_CHANGE_BLOCK_50CA70()
{
...
void miss2_0x11C::SCRCMD_SWITCH_GENERATOR1_50CCB0()
{
    ...
    {
        pPointer->field_8_generator->field_21 = 2;
    }
    else
    {
        pPointer->field_8_generator->field_21 = 1;
    }
...
void miss2_0x11C::SCRCMD_PHONE_TEMPLATE_50CE90()
{
    ...
    // If passed previous mission.
    if (pPassedFlag->field_8_counter >= 1 && pOnMission0->field_8_counter == 0 && pOnMission1->field_8_counter == 0 &&
    ...
    // If failed previous mission.
    if (pFailedFlag->field_8_counter >= 1 && pOnMission0->field_8_counter == 0 && pOnMission1->field_8_counter == 0 &&
        pOnMission2->field_8_counter == 0 && pOnMission3->field_8_counter == 0)
    {
        // If enough respect.
    ...
    // If on mission gang 1.
    if (pOnMission1->field_8_counter >= 1)
    {
    ...
    // If on mission gang 2.
    if (pOnMission2->field_8_counter == 1)
    {
    ...
    // If on mission gang 3.
    if (pOnMission3->field_8_counter == 1)
    {
    ...
    // If already passed.
    if (pPassedFlag->field_8_counter == 1)
    {
    ...
    // If already failed.
    if (pFailedFlag->field_8_counter == 1)
    {
        s32 brief_id = pCmd->field_8_brief_id + 1;
        sprintf(gTmpBuffer_67C598, "%d", brief_id);
        gHud_2B00_706620->field_DC.SetHudBrief_5D4400(1, gTmpBuffer_67C598);
...
MATCH_FUNC(0x50da50)
void miss2_0x11C::SCRCMD_CREATE_LIGHT_50DA50() // CREATE_LIGHT1 or LIGHT_DECSET2
{
...
MATCH_FUNC(0x50dd00)
void miss2_0x11C::SCRCMD_GET_LIVES_MULT_50DD00() // GET_NUM_LIVES or GET_NUM_MULT
{
    SCR_GET_NUM_LIVES_MULTIPLIERS* pCmd = (SCR_GET_NUM_LIVES_MULTIPLIERS*)gBasePtr_6F8070;
...
MATCH_FUNC(0x50e120)
void miss2_0x11C::SCRCMD_SETUP_MODEL_CHECK_50E120()
{
    gCar_6C_677930->field_58_model_to_check_destroy = (u16)gBasePtr_6F8070->field_8_index;
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
void miss2_0x11C::SCRCMD_SET_SPEED_50E780()
{
    ...
    {
        pPointer->field_8_char->field_1F8_run_speed = pCmd->field_A_value;
    }
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
MATCH_FUNC(0x50ea40)
void miss2_0x11C::SCRCMD_FINISH_LEVEL_50EA40()
{
...
MATCH_FUNC(0x50edc0)
void miss2_0x11C::SCRCMD_DO_EASY_PHONE_50EDC0() //  EASY_PHONE_TEMPLATE
{
    SCR_PHONE_TEMPLATE* pCmd = (SCR_PHONE_TEMPLATE*)gBasePtr_6F8070;
...
{
    if ((u16)gBasePtr_6F8070->field_8_index == 0xFFFFu) //  TODO: fix gBasePtr_6F8070
    {
        gCar_6C_677930->field_C_model_unk = car_model_enum::none; //  No model suppressed
    }
    else
    {
        gCar_6C_677930->field_C_model_unk = (u16)gBasePtr_6F8070->field_8_index;
    }
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
{
    gpMapRenderer_6F66E4->set_shading_lev_4E9DB0(((SCR_CMD_HEADER*)gBasePtr_6F8070)[1].field_2_type);
    miss2_0x11C::Next_503620(gBasePtr_6F8070);
}
...
MATCH_FUNC(0x50fb60)
void miss2_0x11C::SCRCMD_SET_ENTER_STATUS_50FB60() // SCRCMD_SET_ENTER_STATUS and SCRCMD_SET_ALL_CONTROLS
{
...
MATCH_FUNC(0x510030)
void miss2_0x11C::SCRCMD_CHANGE_POLICE_510030()
{
...
MATCH_FUNC(0x510280)
void miss2_0x11C::SCRCMD_DO_BASIC_KF_510280()
{
...
MATCH_FUNC(0x5105b0)
void miss2_0x11C::SCRCMD_SET_MODEL_WANTED_5105B0()
{
    SCR_TWO_PARAMS* pCmd = (SCR_TWO_PARAMS*)gBasePtr_6F8070;
...
void miss2_0x11C::PreExecOpCode_5108D0()
{
    if (field_10 != 1)
    {
        ...
        switch (pCmd->field_2_type)
        {
            ...
            case SCRCMD_S_GEQUAL_S:
            case SCRCMD_S_EQUAL_S:
                SCRCMD_S_OP_S_506ED0();
                break;
            case SCRCMD_I_PLUS_S:
            case SCRCMD_I_MINUS_S:
                SCRCMD_I_OP_S_507110();
                break;
            case SCRCMD_S_PLUS_I:
            case SCRCMD_S_MINUS_I:
            case SCRCMD_S_LESS_I:
            ...
            case SCRCMD_SET_CHAR_OBJ2:
                SCRCMD_SET_CHAR_OBJ2_50A200();
                break;
            case SCRCMD_SET_CHAR_OBJ3:
                SCRCMD_SET_CHAR_OBJ3_50A3E0();
                break;
            ...
            case SCRCMD_CHANGE_RESPECT:
            case SCRCMD_CHANGE_GANG_RESP:
                SCRCMD_CHANGE_RESPECT_50ACF0();
                break;
            case SCRCMD_CHECK_RESPECT_GREATER:
            case SCRCMD_CHECK_RESPECT_LESS:
            case SCRCMD_CHECK_RESPECT_IS:
                RespectOperator_50AEF0();
                break;
            case SCRCMD_ADD_PATROL_POINT:
                SCRCMD_ADD_PATROL_POINT_50B0E0();
                break;
            case SCRCMD_SET_AMBIENT:
                SCRCMD_SET_AMBIENT_50B150();
                break;
            case SCRCMD_ANSWER_PHONE:
                SCRCMD_ANSWER_PHONE_50B180();
                break;
            ...
            case SCRCMD_IS_CHAR_FIRE_ONSCREEN:
                SCRCMD_IS_CHAR_FIRE_ONSCREEN_50B3D0();
                break;
            ...
            case SCRCMD_CHAR_TO_BACKDOOR:
                SCRCMD_CHAR_TO_DRIVE_CAR_50B4F0();
                break;
            case SCRCMD_DRIVER_OUT_CAR:
                SCRCMD_DRIVER_OUT_CAR_50B5A0();
                break;
            case SCRCMD_GIVE_DRIVER_BRAKE:
                SCRCMD_GIVE_DRIVER_BRAKE_50B600();
                break;
            case SCRCMD_SET_GANG_INFO1:
                SCRCMD_SET_GANG_INFO1_50B670();
                break;
            case SCRCMD_CLEAR_TIMERS:
                SCRCMD_CLEAR_TIMERS_50B690();
                break;
            ...
            case SCRCMD_CLEAR_WANTED_LEVEL:
                SCRCMD_CLEAR_WANTED_LEVEL_50BA30();
                break;
            ...
            case SCRCMD_MAKE_LEADER:
                ...
                break;
            case SCRCMD_SET_COUNTER_INT:
                SCRCMD_SET_COUNTER_50BDC0();
                break;
            ...
            case SCRCMD_ALTER_WANTED_LEVEL:
                SCRCMD_ALT_WANTED_LEVEL_50BA70();
                break;
            ...
            case SCRCMD_LIGHT_DECSET2:
                SCRCMD_CREATE_LIGHT_50DA50();
                break;
            case SCRCMD_CHECK_NUM_LIVES:
            case SCRCMD_CHECK_MULT:
            case SCRCMD_ADD_LIVES:
            case SCRCMD_ADD_MULTIPLIER:
                GetSetLivesAndMultiplier_50DB70();
                break;
            case SCRCMD_GET_NUM_LIVES:
            case SCRCMD_GET_MULT:
                SCRCMD_GET_LIVES_MULT_50DD00();
                break;
            ...
            case SCRCMD_CHECK_BONUS2:
            case SCRCMD_CHECK_BONUS3:
                SCRCMD_CHECK_BONUS_50E0B0();
                break;
            case SCRCMD_SETUP_MODEL_CHECK:
                SCRCMD_SETUP_MODEL_CHECK_50E120();
                break;
            case SCRCMD_MODEL_CHECK:
                SCRCMD_MODEL_CHECK_50E150();
                break;
            case SCRCMD_GET_CAR_SPEED:
            case SCRCMD_GET_CHAR_CAR_SPEED:
            case SCRCMD_GET_MAX_SPEED:
            ...
            case SCRCMD_S_IS_S_MULT_I:
            case SCRCMD_S_IS_S_MOD_I:
                SCRCMD_S_IS_S_OP_I_50E610();
                break;
            case SCRCMD_GIVE_CAR_ALARM:
                SCRCMD_GIVE_CAR_ALARM_50E7F0();
                break;
            case SCRCMD_CAR_BULLETPROOF:
            case SCRCMD_CAR_ROCKETPROOF:
            case SCRCMD_CAR_FLAMEPROOF:
                SCRCMD_CAR_WEAPON_KIND_PROOF_50E820();
                break;
            case SCRCMD_CHAR_DRIVE_AGGR:
                SCRCMD_CHAR_DRIVE_AGGR_50E730();
                break;
            case SCRCMD_CHAR_DRIVE_SPEED:
            case SCRCMD_SET_RUN_SPEED:
                SCRCMD_SET_SPEED_50E780();
                break;
            case SCRCMD_SET_CHAR_OBJ_FOLLOW:
                SCRCMD_SET_CHAR_OBJ_FOLLOW_50A460();
                break;
            case SCRCMD_PUT_CAR_ON_TRAILER:
                SCRCMD_PUT_CAR_ON_TRAILER_50E900();
                break;
            case SCRCMD_CLEAR_BRIEFS:
                SCRCMD_CLEAR_BRIEFS_50E9A0();
                break;
            case SCRCMD_CHECK_HEADS:
                SCRCMD_CHECK_HEADS_50E9E0();
                break;
            case SCRCMD_FINISH_LEVEL:
                SCRCMD_FINISH_LEVEL_50EA40();
                break;
            case SCRCMD_CHECK_WEAPONHIT:
                SCRCMD_CHECK_WEAPONHIT_50EB00();
                break;
            case SCRCMD_WEAP_HIT_CAR:
            case SCRCMD_ANY_WEAPON_HIT_CAR:
                SCRCMD_WEAP_HIT_CAR_50EBD0();
                break;
            case SCRCMD_IS_CHAR_ON_FIRE:
                SCRCMD_IS_CHAR_ON_FIRE_50ECE0();
                break;
            case SCRCMD_BRIEF_ONSCREEN:
                SCRCMD_BRIEF_ONSCREEN_50ED40();
                break;
            case SCRCMD_CREATE_SOUND:
                SCRCMD_CREATE_SOUND_50ED80();
                break;
            case SCRCMD_DO_EASY_PHONE:
                SCRCMD_DO_EASY_PHONE_50EDC0();
                break;
            ...
            case SCRCMD_SUPPRESS_MODEL:
                ...
                break;
            case SCRCMD_WARP_CHAR:
                SCRCMD_WARP_CHAR_50F270();
                break;
            ...
            case SCRCMD_NO_CHARS_OFF_BUS:
                ...
                break;
            case SCRCMD_KILL_CHAR:
                SCRCMD_KILL_CHAR_50FA00();
                break;
...
{ //  return boolean: true if it has reached LEVELEND, false otherwise
    ...
    if (BasePointer_512770->field_2_type == SCRCMD_START_EXEC)
    {
        do
        {
    ...
    else //  It isn't an EXEC opcode
    {
        ...
        if (BasePointer_512770->field_6_return_value == 1)
        {
            while (1) // execute commands in the same frame
            {
                ...
                if (pCurrentCmd->field_6_return_value != 1 || field_4_next_cmd == 0xFFFF)
                {
                    break;
                }
...
MATCH_FUNC(0x511930)
void miss2_0x11C::InitThread_511930(char_type flags, u16 levelStart)
{
