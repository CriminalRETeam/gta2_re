...
BINKDEC s32   __stdcall BinkOpen(const char* name, s32 flags) { return 0; }
BINKDEC void  __stdcall BinkClose(s32 hbink) {}
BINKDEC void  __stdcall BinkGetSummary(s32 hbink, void* summary) {}
BINKDEC s32   __stdcall BinkDoFrame(s32 hbink) { return 0; }
BINKDEC void  __stdcall BinkNextFrame(s32 hbink) {}
BINKDEC s32   __stdcall BinkWait(s32 hbink) { return 0; }
BINKDEC s32   __stdcall BinkCopyToBuffer(s32 hbink, void* dest, s32 destpitch, s32 destheight, s32 destx, s32 desty, s32 flags) { return 0; }
BINKDEC void  __stdcall BinkSetSoundSystem(void* open, s32 param) {}
BINKDEC void  __stdcall BinkSetIOSize(s32 size) {}
BINKDEC void* __stdcall BinkOpenMiles(s32 driver) { return 0; }
BINKDEC s32   __stdcall BinkBufferOpen(HWND hwnd, s32 width, s32 height, s32 flags) { return 0; }
BINKDEC void  __stdcall BinkBufferClose(s32 hbinkbuffer) {}
BINKDEC void* __stdcall BinkBufferLock(s32 hbinkbuffer) { return 0; }
