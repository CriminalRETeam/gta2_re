...
void miss2_0x11C::SCRCMD_CONVEYOR_DECSET1_2_5043A0(SCR_CONVEYOR* a1, SCR_POINTER* a2)
{
    if (a1->field_C_rect.field_0_pos.field_8_z == dword_6F7570)
    {
        ...
        a1->field_C_rect.field_0_pos.field_8_z =
            gMap_0x370_6F6268->FindGroundZForCoord_4E5B60(a1->field_C_rect.field_0_pos.field_0_x, a1->field_C_rect.field_0_pos.field_4_y);
    }
...
{
    SCR_THREAD* pCmd = (SCR_THREAD*)gfrosty_pasteur_6F8060->GetBasePointer_512770(((SCR_CMD_HEADER*)gBasePtr_6F8070)[1].field_2_type);
    miss2_0x11C* v3;
    s16 v4;
...
void miss2_0x11C::SCRCMD_INCREMENT_507A70()
{
    ...
    pCmd = (SCR_POINTER*)gfrosty_pasteur_6F8060->GetBasePointer_512770(gBasePtr_6F8070->field_8_index);
...
void miss2_0x11C::SCRCMD_HAS_CHAR_DIED_509BB0()
{
    ...
    v2 = (SCR_POINTER*)gfrosty_pasteur_6F8060->GetBasePointer_512770(gBasePtr_6F8070->field_8_index);
...
void miss2_0x11C::SCRCMD_DELAY_HERE_50A940()
{
    ...
    {
        v2->field_0_cmd_this = ((SCR_CMD_HEADER*)gBasePtr_6F8070)[1].field_2_type;
    }
    else
    {
        v2->field_0_cmd_this = gBasePtr_6F8070->field_8_index - 1;
...
void miss2_0x11C::SCRCMD_IS_CHAR_IN_ZONE_50BF40()
{
    ...
    {
        pZone1 = gMap_0x370_6F6268->zone_by_pos_and_type_4DF4D0(pCmd->field_8_char->get_cam_x().ToInt(),
                                                                pCmd->field_8_char->get_cam_y().ToInt(),
                                                                16);
        pZone2 = gMap_0x370_6F6268->zone_by_pos_and_type_4DF4D0(pCmd->field_8_char->get_cam_x().ToInt(),
                                                                pCmd->field_8_char->get_cam_y().ToInt(),
                                                                1);
    }
...
MATCH_FUNC(0x50e150)
void miss2_0x11C::SCRCMD_MODEL_CHECK_50E150() // SCRCMD_MODEL_CHECK
{
...
MATCH_FUNC(0x50e460)
void miss2_0x11C::SCRCMD_SET_CAR_GRAPHIC_50E460() //  SCRCMD_SET_CAR_GRAPHIC
{
...
MATCH_FUNC(0x50e7f0)
void miss2_0x11C::SCRCMD_GIVE_CAR_ALARM_50E7F0() // Give car alarm
{
    SCR_POINTER* pPtr = (SCR_POINTER*)gfrosty_pasteur_6F8060->GetBasePointer_512770(gBasePtr_6F8070->field_8_index);
...
void miss2_0x11C::PreExecOpCode_5108D0()
{
    if (field_10 != 1)
    {
        ...
        switch (pCmd->field_2_type)
        {
            ...
            case SCRCMD_ADD_LIVES:
            case SCRCMD_ADD_MULTIPLIER:
                GetSetLivesAndMultipler_50DB70();
                break;
