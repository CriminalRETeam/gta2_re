...
DEFINE_GLOBAL(bool, gDo_infinite_lives_67D4C9, 0x67D4C9);
DEFINE_GLOBAL(bool, bLimit_recycling_67D4CA, 0x67D4CA);
DEFINE_GLOBAL(bool, bDo_invulnerable_67D4CB, 0x67D4CB);
DEFINE_GLOBAL(bool, bLog_input_67D4CC, 0x67D4CC);
DEFINE_GLOBAL(bool, bSkip_right_67D4E4, 0x67D4E4);
DEFINE_GLOBAL(bool, bSkip_mission_67D4E5, 0x67D4E5);
DEFINE_GLOBAL(bool, bLog_collisions_67D4E6, 0x67D4E6);
DEFINE_GLOBAL(bool, bSkip_bottom_67D4E7, 0x67D4E7);
DEFINE_GLOBAL(bool, bSkip_quit_confirm_67D4E8, 0x67D4E8);
DEFINE_GLOBAL(bool, bDo_iain_test_67D4E9, 0x67D4E9);
DEFINE_GLOBAL(bool, bSkip_draw_67D4EA, 0x67D4EA);
DEFINE_GLOBAL(bool, bDo_release_replay_67D4EB, 0x67D4EB);
DEFINE_GLOBAL(bool, bSkip_traffic_lights_67D4EC, 0x67D4EC);
DEFINE_GLOBAL(bool, bDo_corner_window_67D4EE, 0x67D4EE);
DEFINE_GLOBAL(bool, bSkip_dummies_67D4EF, 0x67D4EF);
DEFINE_GLOBAL(bool, bDo_load_savegame_67D4F0, 0x67D4F0);
DEFINE_GLOBAL(bool, bDo_show_horn_67D4F2, 0x67D4F2);
DEFINE_GLOBAL(bool, bIgnore_replay_header_67D4F3, 0x67D4F3);
DEFINE_GLOBAL(bool, bPlay_replay_67D4F4, 0x67D4F4);
DEFINE_GLOBAL(bool, bDont_get_car_back_67D4F5, 0x67D4F5);
...
DEFINE_GLOBAL(bool, bSkip_fire_engines_67D53A, 0x67D53A);
DEFINE_GLOBAL(bool, bSkip_frontend_67D53B, 0x67D53B);
DEFINE_GLOBAL(bool, bIsFrench_67D53C, 0x67D53C);
DEFINE_GLOBAL(bool, bDo_brian_test_67D544, 0x67D544);
DEFINE_GLOBAL(bool, bSkip_lid_67D546, 0x67D546);
DEFINE_GLOBAL(bool, bShow_player_names_67D54C, 0x67D54C);
DEFINE_GLOBAL(bool, bKeep_weapons_after_death_67D54D, 0x67D54D);
DEFINE_GLOBAL(bool, bSkip_window_check_67D54E, 0x67D54E);
DEFINE_GLOBAL(bool, bDo_show_physics_67D54F, 0x67D54F);
DEFINE_GLOBAL(bool, bSkip_trains_67D550, 0x67D550);
DEFINE_GLOBAL(bool, bSkip_buses_67D558, 0x67D558);
DEFINE_GLOBAL(bool, bDo_show_ids_67D559, 0x67D559);
DEFINE_GLOBAL(bool, bDo_police_1_67D568, 0x67D568);
DEFINE_GLOBAL(bool, bDo_police_2_67D569, 0x67D569);
DEFINE_GLOBAL(bool, bDo_police_3_67D56A, 0x67D56A);
DEFINE_GLOBAL(bool, bSkip_top_67D574, 0x67D574);
DEFINE_GLOBAL(bool, bSkip_recycling_67D575, 0x67D575);
DEFINE_GLOBAL(bool, gDo_show_input_67D576, 0x67D576);
DEFINE_GLOBAL(bool, bSkip_skidmarks_67D585, 0x67D585);
DEFINE_GLOBAL(bool, bNo_annoying_chars_67D586, 0x67D586);
DEFINE_GLOBAL(bool, bDo_show_imaginary_67D588, 0x67D588);
DEFINE_GLOBAL(bool, bDo_show_camera_67D58A, 0x67D58A);
DEFINE_GLOBAL(bool, bSkip_replay_sync_check_67D594, 0x67D594);
DEFINE_GLOBAL(bool, bDo_show_junc_ids_67D5B0, 0x67D5B0);
DEFINE_GLOBAL(bool, bLog_random_extra_67D5BC, 0x67D5BC);
DEFINE_GLOBAL(bool, bConstant_replay_save_67D5C4, 0x67D5C4);
DEFINE_GLOBAL(bool, bDo_blood_67D5C5, 0x67D5C5);
DEFINE_GLOBAL(bool, bDo_mike_67D5CC, 0x67D5CC);
DEFINE_GLOBAL(bool, bShow_hidden_faces_67D5CD, 0x67D5CD);
DEFINE_GLOBAL(bool, bLog_random_67D5FC, 0x67D5FC);
DEFINE_GLOBAL(bool, bDo_show_instruments_67D64C, 0x67D64C);
DEFINE_GLOBAL(bool, bSkip_particles_67D64D, 0x67D64D);
DEFINE_GLOBAL(bool, bSkip_tiles_67D655, 0x67D655);
DEFINE_GLOBAL(bool, bGet_all_weapons_67D684, 0x67D684);
DEFINE_GLOBAL(bool, gDo_miss_logging_67D6BC, 0x67D6BC);
DEFINE_GLOBAL(bool, gShow_cycle_67D6BD, 0x67D6BD);
DEFINE_GLOBAL(bool, bSkip_audio_67D6BE, 0x67D6BE);
DEFINE_GLOBAL(bool, bSkip_left_67D6BF, 0x67D6BF);
DEFINE_GLOBAL(bool, bLog_directinput_67D6C0, 0x67D6C0);
DEFINE_GLOBAL(bool, bDo_sync_check_67D6C1, 0x67D6C1);
DEFINE_GLOBAL(bool, bDo_3d_sound_67D6C2, 0x67D6C2);
DEFINE_GLOBAL(bool, bSkip_ambulance_67D6C9, 0x67D6C9);
DEFINE_GLOBAL(bool, bDo_show_object_ids_67D6CA, 0x67D6CA);
DEFINE_GLOBAL(bool, bDo_free_shopping_67D6CD, 0x67D6CD);
DEFINE_GLOBAL(bool, bDo_debug_keys_67D6CF, 0x67D6CF);
DEFINE_GLOBAL(bool, gDo_text_id_test_67D6D0, 0x67D6D0);
DEFINE_GLOBAL(bool, bLog_routefinder_67D6D1, 0x67D6D1);
DEFINE_GLOBAL(bool, bDo_show_timing_67D6DC, 0x67D6DC);
DEFINE_GLOBAL(bool, bDo_exit_after_replay_67D6E4, 0x67D6E4);
DEFINE_GLOBAL(bool, bDo_show_collision_box_67D6E5, 0x67D6E5);
...
DEFINE_GLOBAL(Debug, gDebug_67D52C, 0x67D52C);
