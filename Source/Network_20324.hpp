...
class Network_20324
{
  public:
    ...
    HWND field_201A8_ui_control_hwnds[3][30];
    s32 field_202D4_showing_specific_window_idx;
    s32 field_202D8_last_showing_specific_window_idx;
    s16 field_202DC;
    s16 field_2031A;
    HWND field_202E0_dlg_hwnd;
    HINSTANCE field_202E4_hInstance;
};
