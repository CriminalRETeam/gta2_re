...
CMAKE_GENERATE_JOM_CMD = "cmake -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DCMAKE_BUILD_TYPE=Release .. -G\"NMake Makefiles JOM\""
CMAKE_BUILD_CMD = "cmake --build . --target ExePatcher" #  -- -j 1
