...
DEFINE_GLOBAL_INIT(Fix16, DAT_0067BA20, Fix16(0x2000, 0), 0x67BA20);
DEFINE_GLOBAL_INIT(Fix16, DAT_0067BBE4, Fix16(0x4000, 0), 0x67BBE4);
DEFINE_GLOBAL_INIT(Fix16, DAT_0067BBE8, Fix16(0x8000, 0), 0x67BBE8);
DEFINE_GLOBAL_INIT(Ang16, DAT_0067BA38, Ang16(0x168), 0x67BA38);
DEFINE_GLOBAL_INIT(Ang16, DAT_0067BB2C, Ang16(0x438), 0x67BB2C);
...
MATCH_FUNC(0x49ca50)
void Door_38::sub_49CA50(u8 gr_id, char_type x, char_type y, char_type z, s32 face)
{
    if (!field_0_primary_door_data)
    {
        field_0_primary_door_data = gDoor_4D4_67BD2C->sub_49CF10(gr_id, x, y, z, face, 0);
        return;
    }
