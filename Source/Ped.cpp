...
void Ped::sub_45C7F0(Car_BC* pCar)
{
    ...
    this->field_278 = 10;
    this->field_27C = 10;
    pCar->field_4_ped_list.AddPassenger_471140(this);
}
    ...
    if (field_168_game_object)
    {
        ...
        if (field_278 == 10)
        {
            ...
            else
            {
                ...
                if (field_25C_car_state == 37 && field_238 == 3 || (field_16C_car->field_4_ped_list.AddPassenger_471140(this), field_238 == 3))
                {
