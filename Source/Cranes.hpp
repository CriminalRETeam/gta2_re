...
class Crane_15C
{
  public:
    ...
    EXPORT void sub_47F2F0(Fix16 a2, Fix16 a3, Sprite* a4);
    EXPORT bool sub_47F350();
    EXPORT bool sub_47F3D0();
    EXPORT bool sub_47F450();
    EXPORT void UpdateCraneTargets_47F4C0();
    EXPORT char_type ComputeHookPolar_47F6C0(Fix16_Point* pPoint, Fix16* pOutF16, Fix16* pOutAng);
    EXPORT void sub_47F7F0(Car_BC* a2);
    ...
    EXPORT void sub_480B60(Fix16 a2, Fix16 a3, Ang16 a4);
