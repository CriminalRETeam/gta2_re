...
const char_type *gListTypes_61AB70[30] =
{
  "objects",
  "corner_space",
  "sprite_space",
...
void FatalError_4A07C0(s32 code, const char_type *pFileName, s32 lineNo, ...)
{
    ...
    case 1118:
    {
        ...
        sprintf(
            gTmpBuffer_67C598,
            "Attempted to pos32 arrow at a 'logical' item, not a physical item. Script line: %d",
            va_1);
        break;
    }
    ...
    case 3013:
    {
        ...
        const char_type *va_2 = va_arg(va, const char_type *);
        s32 *va_3 = va_arg(va, s32 *);
        sprintf(gTmpBuffer_67C598, "%d models in %s but %d models in style", va_3, SourceFileNameFromPath_4A07A0((const char_type *)va_3), va_3);
        break;
    }
