...
class miss2_0x11C
{
  public:
    ...
    EXPORT void SCRCMD_THREAD_DECLARE2_5045D0(SCR_THREAD* a1, s16* a2);
    EXPORT void SCRCMD_THREAD_DECLARE3_504660(SCR_THREAD* a2);
    EXPORT void SCRCMD_THREAD_DECLARE5_504710(SCR_CHAR_AREA_ANY* pCmd);
    EXPORT void SCRCMD_THREAD_DECLARE4_5047C0(SCR_THREAD* a1, s16* a2);
    ...
    EXPORT void DisableThread_505790(u16 a1);
