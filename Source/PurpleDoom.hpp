...
class PurpleDoom
{
  public:
    ...
    EXPORT void AddToSpriteRectBuckets_477B60(Sprite* a1);
    EXPORT void DebugLogAll_477BA0();
    EXPORT char_type CheckAndHandleCollisionInStrips_477BD0(Sprite* a2);
    EXPORT bool CheckAndHandleAllCollisionsForSprite_477C30(Sprite* pSprt, s32 a3);
    ...
    EXPORT Sprite* FindNearestSpriteOfType_477E60(Sprite* a2, s32 a3);
    EXPORT bool CollectRectCollisions_477F30(Fix16_Rect* a2, char_type a3, s32 a4, Sprite* a5, struct_4* a6);
    EXPORT bool CheckRectForCollisions_477F60(Fix16_Rect* a2, char_type a3, s32 a4, Sprite* a5);
    EXPORT PurpleDoom();
    EXPORT ~PurpleDoom();
    EXPORT u32 SearchTileColumnForClosestSprite_478160(u8 a2);
    ...
    EXPORT void AddToRowBuckets_4784D0(s32 idx, Sprite* a3);
    ...
    EXPORT bool CheckAndHandleRowCollisionsForSprite_4787E0(u32 a2, Sprite* a3);
    EXPORT Sprite* FindNearestSpriteInRow_478880(u32 a2, Sprite* a3);
